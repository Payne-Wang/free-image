...
try {
    ...
    console.warn("Could not patch window.fetch for proxy support. The proxy feature may not work.", e);
}
// --- End Proxy Configuration ---


// Call this to force re-initialization after settings change
export const reinitializeGoogleAI = () => {
    aiInstance = null;
};
